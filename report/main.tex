...
\section{References}
\noindent
1. J. Hooman, \textit{Creating a Domain Specific Language (DSL) with Xtext}. Retrieved from \url{https://www.cs.ru.nl/J.Hooman/DSL/Creating_a_Domain_Specific_Language_(DSL)_with_Xtext.pdf}

\noindent
2. Xtext Documentation, \textit{Domain Model Example}. Retrieved from \url{https://eclipse.dev/Xtext/documentation/102_domainmodelwalkthrough.html}


\noindent
3. Introduction to Model Validation and Code Generation with \textit{Epsilon} \url{https://www.youtube.com/watch?v=Z2MJ_oBcfYE}

\noindent
4. The Epsilon Validation Language (EVL) \url{https://eclipse.dev/epsilon/doc/evl/}

\noindent
5. Language Implementation \url{https://eclipse.dev/Xtext/documentation/303_runtime_concepts.html#validation}
